...
public class SnapShots {
	...
	public String takeSnapShotPass() {
		...
		String timeStamp = System.getProperty("user.dir") + "/screenShots/pass"
				+ date.replace(":", "_").replace("/", "_") + ".png";
	...
	public String takeSnapShotFail() {
		...
		SimpleDateFormat sdf = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");
		String date = sdf.format(d);
		String timeStamp = System.getProperty("user.dir") + "/screenShots/fail"
				+ date.replace(":", "_").replace("/", "_") + ".png";
		File dest = new File(timeStamp);
		try {
			FileUtils.copyFile(src, dest);
