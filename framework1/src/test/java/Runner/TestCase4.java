...
import Pageobject.HowtowashclothesPage;
...
public class TestCase4 {
	...
	public static void test() throws IOException, InterruptedException {
		test = Extentreport.startTest("TestCase4");
		try {
			Log log = new Log();
			log.config1();
			HomePage h = new HomePage(driver);
			h.clickHowtowathclothes();
			HowtowashclothesPage c = new HowtowashclothesPage();
			c.clickHowtodolaundry();
			//c.checkHowtodolaundry();
