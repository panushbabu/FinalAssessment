...
import Pageobject.CouponsandRewardsPage;
...
public class TestCase9 {
	...
	public static void test() throws IOException, InterruptedException {
		test = Extentreport.startTest("TestCase9");
		try {
			Log log = new Log();
			log.config1();
			HomePage h = new HomePage(driver);
			h.clickCouponsandRewards();
			CouponsandRewardsPage s = new CouponsandRewardsPage(driver);
	        s.clickSavenow();
